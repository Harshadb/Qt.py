...
class QDateTimeEdit(QAbstractSpinBox):
    ...
    class Sections(sip.simplewrapper):
        ...
        def __init__(self) -> None: ...
        @typing.overload
        def __init__(self, f: typing.Union['QDateTimeEdit.Sections', 'QDateTimeEdit.Panel']) -> None: ...
        @typing.overload
    ...
    def sectionAt(self, index: int) -> 'QDateTimeEdit.Panel': ...
    def event(self, e: QtCore.QEvent) -> bool: ...
    def stepBy(self, steps: int) -> None: ...
    def clear(self) -> None: ...
    def sizeHint(self) -> QtCore.QSize: ...
    def setSelectedSection(self, section: 'QDateTimeEdit.Panel') -> None: ...
    ...
    def sectionText(self, s: 'QDateTimeEdit.Panel') -> str: ...
    def setCurrentSection(self, section: 'QDateTimeEdit.Panel') -> None: ...
    def currentSection(self) -> 'QDateTimeEdit.Panel': ...
